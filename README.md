...
4. Run `./bin/initialize`
   ...
   6. Configure GitHub repository settings (auto-delete merged branches, auto-merge, branch protection requiring pull requests, workflow permissions, `release` environment, `FACTORIO_API_KEY` secret)
